...
<div class="grid grid-cols-1 gap-3">
	...
	<div class="grid grid-cols-1 gap-2">
		...
		<div>
			<h3 class="text-xl">Allgemeine Hinweise</h3>
			<p>
		...
		<div>
			<h3 class="text-xl">Datenerfassung auf dieser Website</h3>
			<h4 class="text-lg">
			...
			<h4 class="text-lg">Wie erfassen wir Ihre Daten?</h4>
			<p>
			...
			<h4 class="text-lg">Wof&uuml;r nutzen wir Ihre Daten?</h4>
			<p>
			...
			<h4 class="text-lg">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
			<p>
	...
	<div>
		<h2 class="text-2xl">2. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
		<h3 class="text-xl">Datenschutz</h3>
		<p>
		...
		<h3 class="text-xl">Hinweis zur verantwortlichen Stelle</h3>
		...
		<p>
			Telefon: +49 7162 3050023<br />
			E-Mail: henrik@henrikfiedler.de
		</p>
		<p>
		...
		<h3 class="text-xl">Speicherdauer</h3>
		<p>
		...
		<h3 class="text-xl">Empf&auml;nger von personenbezogenen Daten</h3>
		<p>
		...
		<h3 class="text-xl">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
		<p>
		...
		<h3 class="text-xl">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
		<p>
		...
		<h3 class="text-xl">Auskunft, Berichtigung und L&ouml;schung</h3>
		<p>
		...
		<h3 class="text-xl">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
		<p>
		...
		<h3 class="text-xl">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
		<p>
	...
	<div>
		<h2 class="text-2xl">3. Datenerfassung auf dieser Website</h2>
		...
		<div>
			<h3 class="text-xl">Server-Log-Dateien</h3>
			<p>
		...
		<div>
			<h3 class="text-xl">Kontaktformular</h3>
			<p>
	...
	<div>
		<p>
			Quelle: <a class="text-blue-600 hover:underline" href="https://www.e-recht24.de">
